...
public class Menu_Almacenero extends javax.swing.JFrame {
 ...
 public Menu_Almacenero() {
    ...
    private void initComponents() {
        ...
        btnCerrarSecionAlmacenero = new javax.swing.JButton();
        ...
        JBT_RegistrarCompra.setText("Registrar Compra");
        ...
        BTNSalidas.setText("Registrar Salida");
        ...
        btnCerrarSecionAlmacenero.setText("Cerrar Secion");
        btnCerrarSecionAlmacenero.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCerrarSecionAlmaceneroActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addComponent(btnCerrarSecionAlmacenero)
                        .addGap(103, 103, 103))))
        );
...
RealizarSalida jif = RealizarSalida.getInstancia(); // 1. Obtener la instancia
...
actualizarNavegacion("Lista de salidad", "Lista de salidad");
    ...
    private void btnCerrarSecionAlmaceneroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCerrarSecionAlmaceneroActionPerformed
// 1. (Opcional) Preguntar si está seguro
    ...
    }//GEN-LAST:event_btnCerrarSecionAlmaceneroActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_Almacenero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Menu_Almacenero().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnCerrarSecionAlmacenero;
...
public void actualizarNavegacion(String titulo, String... ruta) {
    ...
    StringBuilder ubicacion = new StringBuilder("Menú");  for (String paso : ruta) {
